<head>
    <!-- Page Title -->
    <title>Ampernet Telecom<?php if(isset($page)){echo ' | ' . $page;}else{}?></title>
    ...
    <link rel="stylesheet" href="<?=$url?>/assets/plugins/perfect-scrollbar/perfect-scrollbar.min.css">
    <!-- ======= END BEGIN GLOBAL MANDATORY STYLES ======= -->

    <link rel="stylesheet" href="<?=$url?>/assets/fonts/elegant_icons/elegant-icons.css">
